...
class Face_Recognization:
    def __init__(self,root):
        ...
        # button
        b1=Button(self.root,text="Face Recognition",command=self.face_recog, cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg="white")
    ...
    def mark_attendance(self,i,r,n,d):
        with open("project.csv","r+",newline="\n") as f:
            ...
            for line in myDataList:
                entry=line.split((","))       #Kaiwaly, 66, CSE
    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbours, color, text, clf):
            ...
            for(x,y,w,h) in features:
                ...
                #connecting to db
                conn=mysql.connector.connect(host="localhost",user="root",password="kaiwalya",database="face_recognizer")
